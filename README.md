...
- **2021.1.17**：针对 [Daily-Reading](https://github.com/daily-reading/daily-reading) 开设 Tasks 区域，快速链接到其中的待阅读目录中。阅读后将笔记写到日期目录中，备注好「 阅读来源 」，删除 Tasks 中的文件（ Tasks 中的都是 Todo，不需要标记 WIP ）。特别提示：Tasks 中的文章链接还是要收录到 Pocket 中，并在读后 Archive 掉
